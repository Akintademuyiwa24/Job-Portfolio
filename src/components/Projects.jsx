...
const Projects = () => {
  return (
    <div id='project' className='px-5 max-w-[1040px] m-auto md:pl-20 py-16'>
        <h1 className='text-md sm:text-lg font-bold text-[#001b5e]'>PROJECTS</h1>
        <p className='text-sm pb-8 pt-1 font-bold sm:text-xl'>
        ...
        <div className='grid sm:grid-cols-2 gap-12'>
            ...
            <div className='text-center'>
                ...
                <a href="https://github.com/Akintademuyiwa24/Restaurant.git" className='mt-3 font-bold'> <span className='mr-2'>Github</span><BsGithub size={20} className='inline mt-[-5px]'/></a>
        ...
        <div className='grid sm:grid-cols-2 gap-12 mt-20'>
            <div className='text-center'>
                ...
                <div className='sm:flex gap-5 justify-center pt-2 mb-3 mt-2'>
                <a href="https://github.com/Akintademuyiwa24/lemon-app.git" className='mt-3 font-bold'> <span className='mr-2'>Github</span><BsGithub size={20} className='inline mt-[-5px]'/></a> 
        ...
        <ProjectItem img={Moee} title='Search Movie App' link='https://search4movie-app.netlify.app'/>
            <div className='text-center'>
                ...
                <div className='sm:flex gap-5 justify-center pt-2 mb-3 mt-2 '>
                <a href="https://github.com/Akintademuyiwa24/movie-app.git" className='mt-3 font-bold'> <span className='mr-2'>Github</span><BsGithub size={20} className='inline mt-[-5px]'/></a>
